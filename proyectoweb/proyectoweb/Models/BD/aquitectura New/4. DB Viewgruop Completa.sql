...
-- Dumping data for table viewgroup3.grupo_invest: ~2 rows (approximately)
...
-- Dumping data for table viewgroup3.grupo_invest_has_usuario: ~6 rows (approximately)
...
REPLACE INTO `grupo_invest_has_usuario` (`pkf_id_grupo_invest`, `pkf_id_usuario`, `fecha`, `fk_tipo_usuario`, `estado`) VALUES
	(117, 15, '2019-02-25', 1, 1),
	(118, 16, '2019-02-25', 2, 1),
	(118, 17, '2019-02-25', 2, 1),
	(118, 18, '2019-02-25', 2, 1),
	(118, 19, '2019-02-25', 2, 1),
	(118, 24, '2019-02-25', 2, 1);
...
-- Dumping data for table viewgroup3.proyecto: ~6 rows (approximately)
...
-- Dumping data for table viewgroup3.proyecto_has_usuario: ~15 rows (approximately)
...
set g.email_grupo=email,g.telefo_grupo=telefo,g.direcc_grupo=direcc,
g.url_logo_grupo=logo, g.siglas_signif_grupo=sigla, g.objetivo_grupo=objetivo,
g.mision_grupo=mision, g.vision_grupo=vision,g.justif_grupo=justif, g.quien_somos_grupo=quien
