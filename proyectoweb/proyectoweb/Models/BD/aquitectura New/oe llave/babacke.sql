...
-- Dumping data for table viewgroup3.plantilla: ~1 rows (approximately)
...
-- Dumping data for table viewgroup3.soporte: ~3 rows (approximately)
...
REPLACE INTO `usuario` (`id_usuario`, `nom_usuario`, `url_foto_usuario`, `email_usaurio`, `fk_programa`) VALUES
	...
	(15, 'Doctor Quimico', '1 - copia (1).png', 'd.doctor@udla.edu.co', 4),
	(16, 'micht', '1 - copia (1).png', 'm.agilar@udla.edu.co', NULL),
	(17, 'alcalde', '1 - copia (1).png', 'j.alcalde@udla.edu.co', NULL),
	(18, 'quimico', '1 - copia (1).png', 'c.doctors@udla.edu.co', NULL),
	(19, 'laura camila ', '1 - copia (1).png', 'c.laura@udla.edu.co', NULL),
...
-- Dumping structure for view viewgroup3.view_pag_grupo
...
-- Dumping structure for procedure viewgroup3.Consultar__Proyecto
...
-- Dumping structure for procedure viewgroup3.proced_consul_user_date
...
-- Dumping structure for procedure viewgroup3.proced_create_pagina_web
...
-- Dumping structure for procedure viewgroup3.proced_view_consul_paginas
...
-- Dumping structure for procedure viewgroup3.proye_consul_act_proced_pag
...
-- Dumping structure for procedure viewgroup3.p_consul_miebros_total
...
-- Dumping structure for procedure viewgroup3.p_consul_miembro_pag
...
-- Dumping structure for procedure viewgroup3.vista_apropia
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_pag_grupo` AS SELECT pagina_web.id_pagina, pagina_web.fk_id_plantilla, pagina_web.grupo_invest_id_grupo_invest as id_grupo, 
grupo_invest.nom_grupo, CONCAT("../",grupo_invest.url_logo_grupo) as url_logo_grupo ,grupo_invest.siglas_signif_grupo , grupo_invest.id_grupo_invest from plantilla
