...
CREATE TABLE IF NOT EXISTS `actividad` (
  ...
  CONSTRAINT `fk_Actividad_grupo_invest1` FOREIGN KEY (`grupo_invest_id_grupo_invest`) REFERENCES `grupo_invest` (`id_grupo_invest`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE IF NOT EXISTS `grupo_invest` (
  ...
  `Programa_id_Programa` int(11) DEFAULT NULL,
  ...
  KEY `fk_grupo_invest_Programa1_idx` (`Programa_id_Programa`),
  ...
  CONSTRAINT `fk_grupo_invest_Programa1` FOREIGN KEY (`Programa_id_Programa`) REFERENCES `programa` (`id_programa`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `grupo_invest_has_usuario` (
  ...
  KEY `fk_grupo_invest_has_usuario_usuario1_idx` (`usuario_id_usuario`),
  KEY `fk_grupo_invest_has_usuario_grupo_invest1_idx` (`grupo_invest_id_grupo_invest`),
  CONSTRAINT `fk_grupo_invest_has_usuario_grupo_invest1` FOREIGN KEY (`grupo_invest_id_grupo_invest`) REFERENCES `mydb`.`grupo_invest` (`id_grupo_invest`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_grupo_invest_has_usuario_usuario1` FOREIGN KEY (`usuario_id_usuario`) REFERENCES `mydb`.`usuario` (`id_usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `habilidades_has_usuario` (
  ...
  CONSTRAINT `FK_habilidades_has_usuario_habilidades` FOREIGN KEY (`pkf_id_Habilidades`) REFERENCES `habilidades` (`id_Habilidades`),
  CONSTRAINT `FK_habilidades_has_usuario_usuario` FOREIGN KEY (`pkf_id_usuario`) REFERENCES `usuario` (`id_usuario`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `proyecto` (
  ...
  `fk_id_grupo_invest` int(11) NOT NULL,
  `semillero_id_semillero` int(11) NOT NULL,
  `semillero_grupo_invest_id_grupo_invest` int(11) NOT NULL,
  PRIMARY KEY (`id_produc`),
  KEY `fk_producto_grupo_invest1_idx` (`fk_id_grupo_invest`),
  KEY `fk_proyecto_semillero1_idx` (`semillero_id_semillero`,`semillero_grupo_invest_id_grupo_invest`),
  CONSTRAINT `fk_producto_grupo_invest1` FOREIGN KEY (`fk_id_grupo_invest`) REFERENCES `grupo_invest` (`id_grupo_invest`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_proyecto_semillero1` FOREIGN KEY (`semillero_id_semillero`, `semillero_grupo_invest_id_grupo_invest`) REFERENCES `semillero` (`id_semillero`, `grupo_invest_id_grupo_invest`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `proyecto_has_usuario` (
  ...
  CONSTRAINT `FK_proyecto_has_usuario_usuario` FOREIGN KEY (`pkf_id_usuario`) REFERENCES `usuario` (`id_usuario`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `soporte` (
  ...
  CONSTRAINT `fk_soporte_Categoria1` FOREIGN KEY (`Categoria_id_Categoria`) REFERENCES `mydb`.`categoria` (`id_Categoria`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_soporte_grupo_invest1` FOREIGN KEY (`grupo_invest_id_grupo_invest`) REFERENCES `mydb`.`grupo_invest` (`id_grupo_invest`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `tipo_usuario` (
  ...
  `grupo_invest_has_usuario_grupo_invest_id_grupo_invest` int(11) NOT NULL,
  `grupo_invest_has_usuario_usuario_id_usuario` int(11) NOT NULL,
  PRIMARY KEY (`id_rol`),
  KEY `fk_tipo_usuario_grupo_invest_has_usuario1_idx` (`grupo_invest_has_usuario_grupo_invest_id_grupo_invest`,`grupo_invest_has_usuario_usuario_id_usuario`),
  CONSTRAINT `fk_tipo_usuario_grupo_invest_has_usuario1` FOREIGN KEY (`grupo_invest_has_usuario_grupo_invest_id_grupo_invest`, `grupo_invest_has_usuario_usuario_id_usuario`) REFERENCES `mydb`.`grupo_invest_has_usuario` (`grupo_invest_id_grupo_invest`, `usuario_id_usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Volcando datos para la tabla viewgroup3.tipo_usuario: ~3 rows (aproximadamente)
/*!40000 ALTER TABLE `tipo_usuario` DISABLE KEYS */;
REPLACE INTO `tipo_usuario` (`id_rol`, `nom_rol`, `grupo_invest_has_usuario_grupo_invest_id_grupo_invest`, `grupo_invest_has_usuario_usuario_id_usuario`) VALUES
	(1, 'Lider', 0, 0),
	(2, 'miembro', 0, 0),
	(5, 'Administrador', 0, 0);
...
CREATE TABLE IF NOT EXISTS `tipo_usuario_has_menu` (
  ...
  CONSTRAINT `fk_tipo_usuario_has_Menu_Menu1` FOREIGN KEY (`pk_fk_menu`) REFERENCES `mydb`.`menu` (`id_menu`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_tipo_usuario_has_Menu_tipo_usuario1` FOREIGN KEY (`pk_fk_tipo_usuario`) REFERENCES `mydb`.`tipo_usuario` (`id_rol`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
